...
# In[9]:
rttab1=gettrantableNames('input_full.xlsx','Tab1','B2:C480','A2:A480')
rttab2=gettrantableNames('input_full.xlsx','Tab2','B2:C480','A2:A480')
...
#print('-->','up_FBNK_AA_ARRANGEMENT006up_FBNK_AA_INTEREST_AC000')
#print(difflib.get_close_matches('up_FBNK_AA_ARRANGEMENT006up_FBNK_AA_INTEREST_AC000', dbnamelist,len(dbnamelist),0.6))
#matchlist=difflib.get_close_matches('up_FBNK_AA_ARRANGEMENT006up_FBNK_AA_INTEREST_AC000', dbnamelist,len(dbnamelist),0.6)
#for v in matchlist :
...
#         #print(index)
#         if difflib.SequenceMatcher(None, t1word, t2word).ratio() >.6 :
...
#         index=index+1    
#     mdictionary[tab1dbnamekeylist[0]]=slist
    
#print(mdictionary)
#df.to_csv('supercomp.csv')
...
writeTojson('rttab2.json',rttab2) 
writeTojson('rttab2.json',rttab2)

# In[10]:


ctab1=getCountitem(tab1)
ctab2=getCountitem(tab2)
