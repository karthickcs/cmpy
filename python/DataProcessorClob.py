   ...
   def run(self):
        try:        
            ...
            for kvalmaster in keysListtab1[self.sizeval:self.sizeval+99]:
                #print (":"+str(kvalmaster)+":")
                #if str(kvalmaster) != '4026074731' :
                    #continue
...
tab1=readexceldata('mdata.xlsx','Tab1','B2:C480','A2:A480')
tab2=readexceldata('mdata.xlsx','Tab2','B2:C480','A2:A480')
...
ctab1=gettrantablecount('mdata.xlsx','tab1','B2:C480','A2:A480')
ctab2=gettrantablecount('mdata.xlsx','tab2','B2:C480','A2:A480')
...
thread1 = myThread("T-1",0, tab1, tab2, ctab1sorted , ctab2sorted)
